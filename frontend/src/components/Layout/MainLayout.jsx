...
const MainLayout = () => {
  const { isAuthenticated, user, logout, refreshCurrentUser, refreshMaintenance, maintenance } = useAuthStore();
  ...
  }, [isAuthenticated, maintenance?.enabled, user?.role]);
  ...
  if (maintenanceBlocked) {
    return (
      <div className={cn(
        "h-[100dvh] flex items-center justify-center p-4 transition-colors duration-300",
        theme === 'dark'
